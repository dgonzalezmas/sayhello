...
public class HelloWorldImplServiceLocator extends org.apache.axis.client.Service implements com.testing.jawxs.HelloWorldImplService {
    ...
    private java.lang.String HelloWorldImplPort_address = "http://localhost:28080/HiWS";
    ...
    public com.testing.jawxs.HelloWorld getHelloWorldImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.testing.jawxs.HelloWorldImplServiceSoapBindingStub _stub = new com.testing.jawxs.HelloWorldImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.testing.jawxs.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.testing.jawxs.HelloWorldImplServiceSoapBindingStub _stub = new com.testing.jawxs.HelloWorldImplServiceSoapBindingStub(new java.net.URL(HelloWorldImplPort_address), this);
                _stub.setPortName(getHelloWorldImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://jaxws.awan.com/", "HelloWorldImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://jaxws.awan.com/", "HelloWorldImplPort"));
        }
