...
public class HelloWorldProxy implements com.testing.jawxs.HelloWorld {
  private String _endpoint = null;
  private com.testing.jawxs.HelloWorld helloWorld = null;
  ...
  private void _initHelloWorldProxy() {
    try {
      helloWorld = (new com.testing.jawxs.HelloWorldImplServiceLocator()).getHelloWorldImplPort();
      if (helloWorld != null) {
        if (_endpoint != null)
  ...
  public com.testing.jawxs.HelloWorld getHelloWorld() {
    if (helloWorld == null)
      _initHelloWorldProxy();
    return helloWorld;
  }
